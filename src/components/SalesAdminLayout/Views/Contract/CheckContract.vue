<template>
  <el-card class="box-card" style="width:90%;margin:0 auto;">
    ...
    <el-form ref="form" :model="form" label-width="130px" style="width:80%;margin:0 auto;">
      <el-row :gutter="20">
        <el-col :span="10">
          <el-form-item label="客户编号：" prop="name">
            <el-input v-model="form.customerId" placeholder="请输入内容" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10" :offset="1">
          <el-form-item label="销售人员工号：">
            <el-input v-model="form.salespeopleId" placeholder="请输入内容" readonly></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6" :offset="5">
          <el-form-item label="发货地址：">
            <el-input v-model="form.address" placeholder="请输入内容" readonly></el-input>
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item label="合同描述：" style="width:85%;">
