  ...
  <el-card class="box-card" style="width:55%;margin:0 auto;">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px" style="width:55%;margin:0 auto;">
      ...
      <el-form-item label="原密码：" prop="originPwd">
        <el-input v-model="form.originPwd" :readonly="isreadonly"></el-input>
      </el-form-item>
      <el-form-item label="新密码：" prop="newPwd">
        <el-input v-model="form.newPwd" :readonly="isreadonly"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    init() {
      ...
      that.$axios
        ...
        .catch(function(error) {
          that.$alert("获取登录信息失败! " + error.data.msg, "提示", {
